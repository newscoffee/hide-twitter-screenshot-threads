...
- download the latest version `1.0.7` of this repo as a [ZIP file](https://github.com/newscoffee/hide-twitter-screenshot-threads/archive/refs/heads/master.zip) from GitHub.
...
#### firefox
the latest version `1.0.7` is available as an [XPI file](https://github.com/newscoffee/hide-twitter-screenshot-threads/releases/download/1.0.7/hide-twitter-screenshot-threads-firefox-1.0.7.xpi).
